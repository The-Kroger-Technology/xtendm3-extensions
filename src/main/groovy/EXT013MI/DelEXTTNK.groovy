/**
 * @Name: DelEXTTNK.EXTTNK
 * @Description: Delete record on table EXTTNK
...
public class DelEXTTNK extends ExtendM3Transaction {
  ...
  public DelEXTTNK(MIAPI mi, UtilityAPI utility, LoggerAPI logger, ProgramAPI program, MICallerAPI miCaller, DatabaseAPI database) {
    this.mi = mi;
