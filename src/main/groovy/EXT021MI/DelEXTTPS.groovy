/**
 * @Name: DelEXTTPS.EXTTPS
 * @Description: Delete record on table EXTTPS
...
public class DelEXTTPS extends ExtendM3Transaction {
  ...
  public DelEXTTPS(MIAPI mi, UtilityAPI utility, LoggerAPI logger, ProgramAPI program, MICallerAPI miCaller, DatabaseAPI database) {
    this.mi = mi;
