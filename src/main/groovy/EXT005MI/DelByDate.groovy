 ...
 *  1.0.2     20250911  ADY     Added input FACI
 *
 */
...
public class DelByDate extends ExtendM3Transaction {
  ...
  private String inFACI, inFDAT, inTDAT;
  ...
  boolean isValidInput() {
    if (inFACI.isBlank() && inFDAT.isBlank() && inTDAT.isBlank()) {
      mi.error("At least one field - FACI, FDAT, or TDAT - is required.");
      return false;
    }
