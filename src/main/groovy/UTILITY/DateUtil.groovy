...
*/
/****************************************************************************************
Extension Name: DateUtil
Type : ExtendM3Utility
Script Author: Erfan Yousefi
Date: 2021-05-06
...
Benjamin Nowak		    2021-05-06				  1.0             Imported from XtendM3 example
******************************************************************************************/
  ...
  */
  boolean isValidDate(String format, String value) {
   ...
   /**
     ...
     */
   boolean isTimeValid(String time, String format) {
    try {
