/**
 * @Name: DelEXTTPL.EXTTPL
 * @Description: Delete record on table EXTTPL
...
public class DelEXTTPL extends ExtendM3Transaction {
  ...
  public DelEXTTPL(MIAPI mi, UtilityAPI utility, LoggerAPI logger, ProgramAPI program, MICallerAPI miCaller, DatabaseAPI database) {
    this.mi = mi;
