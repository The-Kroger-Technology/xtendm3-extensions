/**
 * @Name: DelEXTTPT.EXTTPT
 * @Description: Delete record on table EXTTPT
 * @Authors:
 *
 * @CHANGELOGS
...
public class DelEXTTPT extends ExtendM3Transaction {
  ...
  public DelEXTTPT(MIAPI mi, UtilityAPI utility, LoggerAPI logger, ProgramAPI program, MICallerAPI miCaller, DatabaseAPI database) {
    this.mi = mi;
