/**
 * @Name: DelEXTDTS.EXTDTS
 * @Description: Delete record on table EXTDTS
...
public class DelEXTDTS extends ExtendM3Transaction {
  ...
  public DelEXTDTS(MIAPI mi, UtilityAPI utility, LoggerAPI logger, ProgramAPI program, MICallerAPI miCaller, DatabaseAPI database) {
    this.mi = mi;
