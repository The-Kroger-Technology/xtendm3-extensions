/**
 * @Name: DelEXTTPP.EXTTPP
 * @Description: Delete record on table EXTTPP
...
public class DelEXTTPP extends ExtendM3Transaction {
  ...
  public DelEXTTPP(MIAPI mi, UtilityAPI utility, LoggerAPI logger, ProgramAPI program, MICallerAPI miCaller, DatabaseAPI database) {
    this.mi = mi;
