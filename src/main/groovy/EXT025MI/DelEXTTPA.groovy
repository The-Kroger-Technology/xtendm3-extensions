/**
 * @Name: DelEXTTPA.EXTTPA
 * @Description: Delete record on table EXTTPA
...
public class DelEXTTPA extends ExtendM3Transaction {
  ...
  public DelEXTTPA(MIAPI mi, UtilityAPI utility, LoggerAPI logger, ProgramAPI program, MICallerAPI miCaller, DatabaseAPI database) {
    this.mi = mi;
