/**
 * @Name: DelEXTCCO.EXTCCO
 * @Description: Delete record on table EXTCCO
...
public class DelEXTCCO extends ExtendM3Transaction {
  ...
  public DelEXTCCO(MIAPI mi, UtilityAPI utility, LoggerAPI logger, ProgramAPI program, MICallerAPI miCaller, DatabaseAPI database) {
    this.mi = mi;
