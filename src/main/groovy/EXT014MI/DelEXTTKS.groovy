/**
 * @Name: DelEXTTKS.EXTTKS
 * @Description: Delete record on table EXTTKS
...
public class DelEXTTKS extends ExtendM3Transaction {
  ...
  public DelEXTTKS(MIAPI mi, UtilityAPI utility, LoggerAPI logger, ProgramAPI program, MICallerAPI miCaller, DatabaseAPI database) {
    this.mi = mi;
