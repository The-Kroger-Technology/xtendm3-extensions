/**
 * @Name: DelEXTTPO.EXTTPO
 * @Description: Delete record on table EXTTPO
 * @Authors:
 *
 * @CHANGELOGS
...
public class DelEXTTPO extends ExtendM3Transaction {
  ...
  public DelEXTTPO(MIAPI mi, UtilityAPI utility, LoggerAPI logger, ProgramAPI program, MICallerAPI miCaller, DatabaseAPI database) {
    this.mi = mi;
