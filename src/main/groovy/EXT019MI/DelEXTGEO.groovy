/**
 * @Name: DelEXTGEO.EXTGEO
 * @Description: Delete record on table EXTGEO
...
public class DelEXTGEO extends ExtendM3Transaction {
  ...
  public DelEXTGEO(MIAPI mi, UtilityAPI utility, LoggerAPI logger, ProgramAPI program, MICallerAPI miCaller, DatabaseAPI database) {
    this.mi = mi;
