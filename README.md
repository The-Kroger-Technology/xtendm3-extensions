...
# Kroger. XtendM3 Extensions
A sample repository for Kroger XtendM3 Extensions

## Introduction
This repository is a sample repository for Kroger XtendM3 Extensions. The idea is to keep all customer's extension in one repository and collaborate to create, maintain and update Extensions in a central repository and move to customer's environment when needed.
